...
SET IDENTITY_INSERT BD_TRAVEL.MKT.TICKET OFF
GO

-- CREAR INDICE

CREATE INDEX IDX_NOM_EVENTO_TICKET
ON MKT.TICKET (NOM_EVENTO)
GO

-- CREAR UN ÍNDICE ÚNICO

CREATE UNIQUE INDEX IDX_NOM_PRODUCTO
ON MKT.PRODUCTO (NOM_PRO)
GO

-- CREAR INDICE INCLUYENDO CAMPOS

CREATE INDEX IDX_NOM_POSTULANTE
ON MKT.POSTULANTE (NOM_POS)
  INCLUDE (ECI_POS, FRE_POS)
GO

-- VISUALIZAR INDICES DE UNA TABLA

SP_HELPINDEX 'MKT.TICKET'
GO


/*  MODIFICAR ÍNDICES  */

-- RECONSTRUIR ESTRUCTURA Y REACTIVARLA

ALTER INDEX IDX_NOM_EVENTO_TICKET
ON MKT.TICKET REBUILD
GO

-- DESACTIVAR ÍNDICE

ALTER INDEX IDX_NOM_EVENTO_TICKET
ON MKT.TICKET DISABLE
GO

-- VISUALIZAR ÍNDICES CREADOS DE UNA BD
